...
const adminParkingAttendantTeamLeaderRoutes = async (to, from, next) => {
    ...
    if (!signedIn) {
        ...
        if (
            signedIn.user.role === "service_role" ||
            signedIn.user.role === "supabase_admin" ||
            signedIn.user.role === "admin" ||
            signedIn.user.app_metadata.role === "team_leader" ||
            signedIn.user.app_metadata.role === "parking_attendant"
        ) {
            next();
            return;
        }
    ...
    routes: [
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    component: () =>
                        import("@/views/pages/ManageEventsAndAnnouncements/ManageEventsAndAnnouncements.vue"),
                ...
                },
                {
                    ...
                    children: [
                        ...
                        },
                        {
                            path: "parking-limit",
                            name: "Parking Limit",
                            component: () => import("@/views/pages/Maintenance/ParkingLimit.vue"),
                            beforeEnter: adminOnly,
                        },
                    ],
                },
