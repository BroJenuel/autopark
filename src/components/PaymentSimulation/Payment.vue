...
<template>
    <Dialog v-model:visible="showDialog" :style="{ width: '30rem', margin: '0 10px' }" header="Payment" modal>
        ...
        <div v-if="paymentMethod === 'gcash'" class="flex flex-column gap-3 justify-content-center align-items-center"
            ...
            <div class="flex justify-content-center">
                <Button :disabled="!paymentMethodData.one_time_code" @click="$emit('pay', paymentMethodData)">PAY</Button>
            </div>
        </div>


        <div v-if="paymentMethod === 'maya'" class="flex flex-column gap-3 justify-content-center align-items-center"
             style="margin-bottom: 30px">
        ...
        <div v-if="paymentMethod === 'cod'" class="flex flex-column gap-3 justify-content-center align-items-center"
             style="margin-bottom: 30px">
            <img alt="sdf" src="https://www.pngitem.com/pimgs/m/291-2912475_vector-illustration-of-hand-offers-payment-cash-dollar.png" width="200" />

            <Message severity="warn">
                If you choose COD, the slot will be open for 15 minutes for your convenience. If you have not arrived at the slot after the time limit, the slot will be closed, but will only be available for others. The slot will be available again for you after a day.
            </Message>
