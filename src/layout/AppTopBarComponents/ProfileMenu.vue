...
const accountLabel = computed(() => {
    const first_name =
        userStore.session && userStore.session.user && userStore.session.user.user_metadata && userStore.session.user.user_metadata.first_name
            ? userStore.session.user.user_metadata.first_name
            : "Profile";
    const last_name =
        userStore.session && userStore.session.user && userStore.session.user.user_metadata && userStore.session.user.user_metadata.last_name
            ? userStore.session.user.user_metadata.last_name
            : "";
