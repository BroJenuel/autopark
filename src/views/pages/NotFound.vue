                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style="border-radius: 53px">
                    ...
                    <router-link to="/" class="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
                        ...
                        <span class="ml-4 flex flex-column">
                            <span class="text-900 lg:text-xl font-medium mb-0">Go to Dashboard</span>
                            <span class="text-600 lg:text-xl">Are you lost? You can go back to dashboard.</span>
                        </span>
                    </router-link>
                    <router-link to="/auth/login" class="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
                        <span class="flex justify-content-center align-items-center bg-indigo-400 border-round" style="height: 3.5rem; width: 3.5rem">
                            <i class="pi pi-fw pi-unlock text-50 text-2xl"></i>
                        </span>
                        <span class="ml-4 flex flex-column">
                            <span class="text-900 lg:text-xl font-medium mb-0">Go to Login Page</span>
                            <span class="text-600 lg:text-xl">Sign In or Create a new account to start managing your parking.</span>
                        </span>
                    </router-link>
                </div>
            </div>
