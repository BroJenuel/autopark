...
import ManageEventsAndAnnouncementsStoreModal
    from '@/components/ManageEventsAndAnnouncement/ManageEventsAndAnnouncementsStoreModal.vue';
...
<template>
    <ManageEventsAndAnnouncementsStoreModal ref="ManageEventsAndAnnouncementsStoreModalRef"
    ...
    <div class="card">
        <div class="flex justify-content-between align-items-center">
            ...
            <div class="flex align-items-center">
                ...
                <Button icon="pi pi-refresh" severity="secondary" title="Refresh" @click="getEventsAndAnnouncements()" />
            </div>
        </div>
        <DataTable
