        ...
        <div class="card">
            ...
            >
                ...
                <Column field="parking_slot" header="Area">
                    <template #body="{ data }">
                        <div>
                            <div>Area: <b>{{ data.parking_slot.area }}, {{ data.parking_slot.street }}</b></div>
                            <div>LatLng: <b>{{ data.parking_slot.latitude }} - {{ data.parking_slot.longitude }}</b>
                            </div>
                        </div>
                    </template>
                </Column>
                ...
                <Column field="payment_method" header="Payment Method" sortable>
                    <template #body="{data}">
                        ...
                        <img v-else-if="data.payment_method === 'gcash'" :src="GCashLogo" alt="" class="bg-white p-1"
